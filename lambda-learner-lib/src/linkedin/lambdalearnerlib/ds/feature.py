...
from linkedin.lambdalearnerlib.ds.types import Name, NameTerm, Term, Value


class Feature(object):
    """
    Data structure to hold a single feature. The current implementation supports the flattened name-term-value format
    with additional metadata to hold an index value which is used to convert to and from a sparse representation
